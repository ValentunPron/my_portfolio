...
function AboutSection() {
  const [tab, setTab] = React.useState('cybersecurity');
      ...
      <div className='md:grid md:grid-cols-2 gap-12 md:gap-8 items-center py-8 xl:gap-16 sm:py-16'>
        <div className="relative textAnimationHover hover:rotate-1">
          <Image
            ...
            width={400}
            height={400}
            className='rounded-lg relative z-20 border md:w-auto md:h-auto mx-auto'
          />
          <div className="neonImage absolute xl:mx-[120px] mx-[70px] top-0 h-full inset-1 rounded-md blur-md blueGradientText animate-neon z-10"></div>
        </div>
        <div className='mt-6 md:mt-0 text-left flex flex-col h-full'>
          ...
          <div className='flex sm:flex-row flex-col mt-8 sm:gap-3 gap-5'>
            <button
